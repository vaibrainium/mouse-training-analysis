...
# def global_fit(
#     observations, inputs, masks, state_range=np.arange(2, 6), n_initializations=20, fitting_method="em", n_iters=200, tolerance=10**-4, n_jobs=-1
# ):
#     """
...
#         fit_ll = glm_hmm.fit(
#             observations, inputs=inputs, masks=masks, method=fitting_method, num_iters=n_iters, initialize=False, tolerance=tolerance
#         )
...
#             observations[idx_session][test_idx], inputs=inputs[idx_session][test_idx], masks=masks[idx_session][test_idx]
#         )
